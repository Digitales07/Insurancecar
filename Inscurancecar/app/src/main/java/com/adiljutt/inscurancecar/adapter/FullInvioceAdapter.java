...
import com.adiljutt.inscurancecar.FullReportDetailListActivity;
...
public class FullInvioceAdapter extends RecyclerView.Adapter<FullInvioceAdapter.ViewHolder> {

    private Context mContext;
    private List<FullVioceReport> mUsers;


    public FullInvioceAdapter(Context mContext, List<FullVioceReport> mUsers){
        this.mUsers = mUsers;
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        ...
        FullVioceReport user = mUsers.get(position);
...
//                Toast.makeText(mContext, ""+user.getName(), Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(mContext, FullReportDetailListActivity.class);
