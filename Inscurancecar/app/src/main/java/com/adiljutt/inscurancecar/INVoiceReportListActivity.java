...
public class INVoiceReportListActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    List<VoiceReports> appointments;
    InvioceAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_invoice_report_list);
        ButterKnife.bind(this);

        db = FirebaseDatabase.getInstance();
        pharmacies = db.getReference("InVoiceReport");
        ...
        searchView.setOnQueryTextListener(new SimpleSearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                List<VoiceReports> newValet = new ArrayList<>();

                for (VoiceReports user : appointments){
                    if (user.getReport_id().contains(newText)){
                        newValet.add(user);
                    }
                }

                adapter = new InvioceAdapter(INVoiceReportListActivity.this,newValet);
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists() && dataSnapshot.getChildrenCount() > 0){
                    for (DataSnapshot snapshot:dataSnapshot.getChildren()){
                        VoiceReports medication = snapshot.getValue(VoiceReports.class);
    ...
    private void setUprecyclerView() {
        ...
        adapter = new InvioceAdapter( INVoiceReportListActivity.this,appointments);
